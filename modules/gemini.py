...
class Gemini:
    ...
    def __init__(self):
        ...
        self.config = Config()
        self.model = YOLO("model/best_full_integer_quant_edgetpu.tflite", task="detect")
            ...
            try: 
                ...
                while True:
                    ...
                    try:
                        ...
                        results = self.model.predict(color_image, classes=[1], conf=0.25)
                        ...
                        if x >= 0 and y >= 0 and y < depth_image.shape[0] and x < depth_image.shape[1]:
                            depth_value = int(depth_image[y, x])  # mm
                        else:
                            depth_value = 0

                        camera_param = self.pipeline.get_camera_param()
                        intrinsics = camera_param.depth_intrinsic
